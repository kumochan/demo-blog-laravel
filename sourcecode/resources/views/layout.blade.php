...
<body class="app">
        ...
        <div class="sidebar">
            <div class="sidebar-inner">
                ...
                <ul class="sidebar-menu scrollable pos-r">
                    <li class="nav-item mT-30 actived"><a class="sidebar-link" href="{{ route('post.index') }}"><span class="icon-holder"><i class="c-blue-500 ti-home"></i> </span><span class="title">Bài viết</span></a></li>
    ...
    <script type="text/javascript" src="{{ asset('backend/vendor.js') }}"></script>
    <script type="text/javascript" src="{{ asset('backend/bundle.js') }}"></script>
   </body>
</html>
